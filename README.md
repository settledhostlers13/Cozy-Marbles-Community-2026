...
# 🎮 Cozy Marbles — Community Edition

**A standalone offline build of the relaxing marble puzzle game.**
...
Cozy Marbles is a relaxing physics-based puzzle game where players guide marbles through handcrafted courses, solving gentle challenges at their own pace. This Community Edition is a standalone build of the game, packaged as a self-contained release that requires no storefront and no additional software. All content from the base game is included, and the build runs fully offline once installed.

This build is for players who want a self-contained, offline version of Cozy Marbles that is ready to play immediately on Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2836460/56fa90484fbfe21b5c9f97b468ff6165a6c74e90/ss_56fa90484fbfe21b5c9f97b468ff6165a6c74e90.1920x1080.jpg?t=1787245773" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2836460/d4974654a4ba4df22fc5dd13dcd171b3c2d4a1ea/ss_d4974654a4ba4df22fc5dd13dcd171b3c2d4a1ea.1920x1080.jpg?t=1787245773" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2836460/cf822fca058606864f53bf26f4ef656faefb8201/ss_cf822fca058606864f53bf26f4ef656faefb8201.1920x1080.jpg?t=1787245773" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🎯 **Physics-Based Puzzles** — Guide marbles through 120+ handcrafted courses using ramps, bumpers, and gravity.
- 🧘 **Relaxed Gameplay** — No timers, no fail states — progress at your own pace in a calm environment.
- 🎨 **Hand-Painted Visuals** — Six themed worlds rendered in a soft, watercolor-inspired art style.
- 🎵 **Ambient Soundtrack** — Original lo-fi and acoustic tracks that adapt to each world's atmosphere.
- 🛠️ **Level Editor** — Design and share custom marble courses with the built-in editor.
- 🏆 **Collectibles** — Discover hidden gems and enable 40+ marble skins across all worlds.
- 💾 **Offline Saves** — Progress is stored locally, so the game runs entirely without an internet connection.
- 🖥️ **Lightweight Build** — Runs smoothly on older hardware with minimal storage and memory requirements.
...
| **Additional** | DirectX 11 compatible sound card | Headphones or speakers for full soundtrack experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\CozyMarbles\Saved`
